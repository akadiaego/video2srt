...
public class SpeechUtil {
    ...
    private static final String mp3path = "D:\\project\\video2srt\\src\\main\\resources\\File\\test11.mp3";
    private static final String pcmpath = "D:\\project\\video2srt\\src\\main\\resources\\File\\test12.pcm";

    public static void main(String[] args) throws IOException {
// SpeechSynthesizer("简单测试百度语音合成", "d:/SpeechSynthesizer.mp3");
        convertMP32Pcm(mp3path,pcmpath);
        SpeechRecognition(pcmpath,"pcm");
    }
    /** * 单例 懒加载模式 返回实例 * @return */
    ...
    /** * 语音合成 * @param word 文字内容 * @param outputPath 合成语音生成路径 * @return */
...
// client.setSocketProxy("proxy_host", proxy_port); // 设置socket代理
    ...
    /** * 语音识别 * @param videoPath * @param videoType * @return */
...
// client.setSocketProxy("proxy_host", proxy_port); // 设置socket代理
    ...
    /** * mp3转pcm * @param mp3filepath MP3文件存放路径 * @param pcmfilepath pcm文件保存路径 * @return */
    ...
    /** * 获得pcm文件的音频流 * @param mp3filepath * @return */
